...
- **Remote:** `https://github.com/user-handle/yt-nota.git` (público, recém-criado, vazio)
- **Local:** `<user-home>\00_projetos\yt-nota\`
- **Tudo versionado:** código, testes, prompts, plano (`docs/plan.md`), changelog, README. Nada fica solto fora do repo.

## Arquitetura

```
<user-home>\00_projetos\yt-nota\
├── .git/                     # remote: github.com/user-handle/yt-nota
├── docs/
...
# Arquivo de fila
yt-nota --file <user-home>/Desktop/queue.txt
...
- **O que isso muda pra mim** — aplicação à carreira/projetos da User
...
## Setup pra User (uma vez)

```bash
cd <user-home>/00_projetos
...
| Caminho | Função |
|---|---|
| `<user-home>\00_projetos\yt-nota\pyproject.toml` | package + entry point `yt-nota` |
| `<user-home>\00_projetos\yt-nota\src\yt_nota\cli.py` | argparse, orquestração |
| `<user-home>\00_projetos\yt-nota\src\yt_nota\extractor.py` | yt-dlp wrapper |
| `<user-home>\00_projetos\yt-nota\src\yt_nota\transcript.py` | VTT parser robusto |
| `<user-home>\00_projetos\yt-nota\src\yt_nota\synthesizer.py` | Anthropic SDK call |
| `<user-home>\00_projetos\yt-nota\src\yt_nota\vault.py` | escrita no Obsidian |
| `<user-home>\00_projetos\yt-nota\src\yt_nota\prompts\synthesis.md` | template editável |
| `<user-home>\00_projetos\yt-nota\tests\test_transcript.py` | mínimo de regressão pra VTT |
